...
    *x = 11;  //changes the value of the variable thats passed into the arguments to 11 by pointing to the memory location of the variable
...
int main = 1;  //was 1 first

  

pointer(&main);  //now changed to 11 (as the argument passed here is not the variable, but the address of the variable)
