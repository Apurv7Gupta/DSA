...
| ------------------------------------------------------------------------------- | --------- | ------------ | ---------- | -------- | ------ | ------------------- |
| [Quick Sort](https://www.geeksforgeeks.org/dsa/quick-sort-algorithm/)           | nlogn     | nlogn        | n2n2       | lognlogn | No     | Partitioning        |
| [Merge Sort](https://www.geeksforgeeks.org/dsa/merge-sort/)                     | nlogn     | nlogn        | nlogn      | n        | Yes    | Merging             |
| [Heap Sort](https://www.geeksforgeeks.org/dsa/heap-sort/)                       | nlogn     | nlogn        | nlogn      | 1        | No     | Selection           |
| [Insertion Sort](https://www.geeksforgeeks.org/dsa/insertion-sort-algorithm/)   | n         | n2n2         | n2n2       | 1        | Yes    | Insertion           |
| [Tim Sort](https://www.geeksforgeeks.org/dsa/timsort/)                          | n         | nlogn        | nlogn      | n        | Yes    | Insertion & Merging |
| [Selection Sort](https://www.geeksforgeeks.org/dsa/selection-sort-algorithm-2/) | n2        | n2           | n2         | 1        | No     | Selection           |
| [Shell Sort](https://www.geeksforgeeks.org/dsa/shell-sort/)                     | nlogn     | n4/3n4/3     | n3/2n3/2   | 1        | No     | Insertion           |
